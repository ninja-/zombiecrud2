...
export class zombieItems1560520108818 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("ALTER TABLE `zombie` ADD `itemsJSON` varchar(255)");
    ...
    public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        // await queryRunner.query("ALTER TABLE `pet` ADD FOREIGN KEY (`user_id`) REFERENCES `user`(`id`) ON DELETE CASCADE ON UPDATE RESTRICT");
    }
